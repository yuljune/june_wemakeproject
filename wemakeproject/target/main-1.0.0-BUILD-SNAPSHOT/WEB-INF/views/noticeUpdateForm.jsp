...
<html>
    	...
    	<div class="container">
    		...
    		<form id="frm" action="noticeUpdate" method="post">
                ...
                <select id="category" name="category">
	               <option value="공지사항" <c:if test="${detail.category eq '공지사항' }">selected</c:if>>공지사항</option>
	               <option value="공모전" <c:if test="${detail.category eq '공모전' }">selected</c:if>>공모전</option>
              	</select>
                <table>
                    <tr>
    ...
    <script>
	    ...
	    function goBack(){
			location.href="./noticeDetail?idx=${detail.idx}";
