...
<html>
    ...
    <body>
	    ...
	    <div id="contents_area">
	    	...
	    	<p class="tit">
	    		<!-- <img src="./resources/img/login_tit.png" alt="회원탈퇴"> -->
	    	</p>
	    	<p class="stit">We Make Project 홈페이지를 이용해 주셔서 감사합니다. 회원탈퇴를 원하시면 아이디와 비밀번호를 입력해 주세요.</p>
	    	<div class="login_box">
	    	<form action="membershipDelete" method="post" id="userDelete">
	    	<fieldset>
	    		<legend>회원탈퇴</legend>
	    		<ul>
	    			<li>
	    		...
	    		<a onclick="userDelete()" class="loginBtn">회원탈퇴</a>
	    	</fieldset>
	     	</form>
	     	</div>
	     	</div>
    ...
    <script>
		...
		function userDelete(){
			if(confirm("회원탈퇴 진행을 하시겠습니까?") == true){
				$("#userDelete").submit();
			}else{
				return;
			}
