...
<html>
	...
	<jsp:include page="header.jsp"/>
		<div class="container">
		<span class="dkdk">팀 게시판 글 작성</span>
    	<div class="outter">
   		<form id="frm" action="teamWrite" method="post">
   		<input type="hidden" name="project_idx" id="project_idx" value="${project_idx }"/>
               ...
               <table>
                   ...
                   <tr>
                       ...
                       <td class="title"><input type="text" id="user_id" name="user_id" value="${user_id}" readonly/></td>
                   </tr>
               </table>
               <hr/>
               <table>
	...
	<script>
		function goBack(){
			location.href="./projectTeamBoardMove?project_idx="+${project_idx};
		}
