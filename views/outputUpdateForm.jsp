...
<html>
    ...
    <div class="container">
    		<br/><br/><br/><h2 id="page">게시글 수정</h2>
    	<div class="outter">
		
   		<form id="frm" action="outputUpdate" method="post">
               <hr/>
               <table>
                   <tr>
                   ...
                   <tr>
                       ...
                       <td class="title"><input type="text" id="user_id" name="user_id" value="${detail.user_id }" readonly/>
                       <input type="hidden" id="category" name="category" value="완성"/>
               ...
               <table>
                   <tr>
                       <td class="subj">내용</td>
                       <td class="tdSe"><textarea name="smarteditor" id="smarteditor" rows="10" cols="100" style="width:100%; height:412px;">
	                       ${detail.content }
	                       </textarea>
               ...
               <div>
					...
					<input class="Btn" type="button" value="취소" onclick="goBack()"/>
				</div>
   		</form>
  		</div>
   	</div>
    ...
    function goBack(){
		location.href="./outputDetail?idx=${detail.idx}";
